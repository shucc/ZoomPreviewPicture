...
public final class GPreviewBuilder {
     ...
     * @return GPreviewBuilder
     * **/
    public <T extends IThumbViewInfoModel> GPreviewBuilder setData(@NonNull ArrayList<T> imgUrls) {
     ...
     * @return GPreviewBuilder
     * **/
    public GPreviewBuilder setUserFragment(@NonNull Class<? extends GPreviewFragment> className) {
